...
<nav class="navbar navbar-expand-lg navbar-light navbar-laravel">
    <div class="container">
        <a class="navbar-brand" href="#">Memulihkan kata sandi pengguna</a>
...
<main class="login-form">
    <div class="cotainer">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">Memulihkan kata sandi</div>
                    <div class="card-body">
                        <form action="#" method="POST" name="recover_psw">
                            <div class="form-group row">
                                <label for="email_address" class="col-md-4 col-form-label text-md-right">Alamat Email Anda</label>
                                <div class="col-md-6">
                            ...
                            <div class="col-md-6 offset-md-4">
                                <input type="submit" value="Memulihkan Kata Sandi" name="recover">
                            </div>
                    </div>
                    </form>
                </div>
